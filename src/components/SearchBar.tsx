...
const SearchBar = ({onSubmit, onReset, placeHolder, searchQuery}: Props) => {
  // ^^^ using a prop because onSubmit will have 
  //     a different function depending on which
  //     page user is on.
  ...
  return <Form {...form}>
    <form 
      ...
      className={`flex items-center gap-3 justify-between flex-row border-2 mx-4 rounded-full p-3
